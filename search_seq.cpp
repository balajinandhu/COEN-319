...
int main(int argc, char*argv[]){
    ...
    unsigned offset = std::distance(it_beg, it_res);
	...
	line_nos.push_back(line_count+1);
	...
	cout<<"Number of occurences of pattern in text: "<<line_nos.size()-1<<endl;
	//print line numbers 
	cout<<"The line numbers where the pattern occurs are: "<<endl;
	for(vector<int>::iterator itr = line_nos.begin();itr<line_nos.end()-1;++itr){
		cout<<*itr<<endl;
